...
if os.path.exists(Y_TRAIN_PICKLE) and os.path.exists(X_TRAIN_PICKLE):
    ...
    if READ_WHOLE_TRAIN_DATA:
        ...
        train = pd.read_csv(TRAIN_DATA_PATH, dtype={'acoustic_data': np.int16, 'time_to_failure': np.float32}, nrows=50000)
...
submission.to_csv(f'{DATA_PATH}\\submission_150RowWindow.csv')