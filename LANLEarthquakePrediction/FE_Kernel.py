...
np.save(NP_DATA_PATH + "\\X_train_scaled.npy",X_train_scaled)
print("X_train_scaled")
#print(X_train_scaled)

X_test_scaled = np.array(X_test_scaled)
np.save(NP_DATA_PATH + "\\X_test_scaled.npy",X_test_scaled)
print("X_test_scaled")
#print(X_test_scaled)

y_tr = np.array(y_tr)
np.save(NP_DATA_PATH + "\\y_tr.npy",y_tr)
print("y_train")
#print(y_tr)